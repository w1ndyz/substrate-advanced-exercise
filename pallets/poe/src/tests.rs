...
fn create_claim_works() {
    new_test_ext().execute_with(|| {
        ...
        assert_eq!(Proofs::<Test>::get(&claim), Some((1, frame_system::pallet::Pallet::<Test>::block_number())));
    });
}
...
fn transfer_claim_works() {
    new_test_ext().execute_with(|| {
        ...
        assert_eq!(Proofs::<Test>::get(&claim), Some((2, frame_system::pallet::Pallet::<Test>::block_number())));
    });
}
